					...
					<div class="col-sm-8 offset-2">
						<div class="card shadow">
							<div class="card-header">
								<h6 class="m-0 font-weight-bold text-success">Detail Mobil</h6>
							</div>
							<div class="card-body">
								<div class="row">   
									<div class="col-md-6">
									...
									<div class="col-md-6">
                                        ...
                                        <div class="row align text-center">
									        <div class="col">
                                                ...
                                                <a href="<?= base_url('Mobil/hapus/' . $data['id']) ?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Hapus</a>
